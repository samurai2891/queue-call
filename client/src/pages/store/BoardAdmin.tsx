...
function BoardAdminContent() {
  ...
  const qrCodeUrl = useMemo(() => {
    if (!boardUrl) return '';
    return `https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=${encodeURIComponent(boardUrl)}`;
  }, [boardUrl]);
      ...
      <div className="container py-8 max-w-4xl">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">{t('admin.boardManagement')}</h1>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              {t('admin.boardDisplayUrl')}
            </CardTitle>
            <CardDescription>
              {t('admin.boardDisplayDesc')}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            {/* URL Display */}
            <div className="space-y-2">
              <Label htmlFor="board-url">{t('admin.displayUrl')}</Label>
            ...
            <div className="flex flex-wrap gap-3 pt-4 border-t">
              ...
              <Dialog open={qrDialogOpen} onOpenChange={setQrDialogOpen}>
                ...
                <DialogContent className="sm:max-w-md">
                  <DialogHeader>
                    <DialogTitle>{t('admin.boardQrCode')}</DialogTitle>
                    <DialogDescription>
                      {t('admin.boardQrCodeDesc')}
                    </DialogDescription>
                  </DialogHeader>
